...
with open('/Users/drpsychoben/PycharmProjects/StringBuilderCharts/CustomStringBuilder/CustomStringBuilder_performance.csv', 'r') as csvfile:
...
for method_name, times in methods:
    ...
    plt.ylabel('Time (ns)')
    plt.title(f'CustomStringBuilder.{method_name} Performance')
    plt.grid(True)
    plt.legend()
